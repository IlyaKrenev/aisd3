    ...
    mergeSort() {
        ...
        const merge = (arrFirst, arrSecond) => {
            ...
            while (i < arrFirst.length && j < arrSecond.length) {
                arrSort.push((arrFirst[i] < arrSecond[j]) ?
...
class Main {
    constructor() {
        ...
        this.sortedArrayContainer = null;
        this.outArray = null;
        this.applyButton = null;
        this.generateButton = null;
        this.generateInput = null;
        ...
        this.initButtons = () => {
            ...
            const buttons = Object.entries(mapper).map(([name, displayName]) => {
        ...
        this.showElem = (elem, block = 'block') => {
